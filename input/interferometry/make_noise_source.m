...
noise_spectrum(:,1)=exp(-(abs(f_sample)-0.07).^2/bandwidth^2);
...
noise_spectrum(:,2)=exp(-(abs(f_sample)-0.12).^2/(0.5*bandwidth)^2)';
...
noise_source_distribution(:,:,1)=1.5*(exp(-((X-0.6e6).^2+(Z-0.6e6).^2)/(0.2e6)^2))';
